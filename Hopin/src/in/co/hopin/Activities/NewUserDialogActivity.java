	...
	{	
		...
		buttonClose.setOnClickListener(new OnClickListener() {				
			...
			public void onClick(View buttonClose) {
				HopinTracker.sendEvent("NewUserDialog","ButtonClick","newuserdialog:click:close",1L,getTrackerMap());
				finish();
			}
			});
		...
		if(thisNearbyUserFBInfo.FBInfoAvailable())
		{
			...
			public void onClick(View buttonClose) {
				...
				HopinTracker.sendEvent("NewUserDialog","ButtonClick","newuserdialog:click:hopinIcon",1L,getTrackerMap());
		...
		chatIcon.setOnClickListener(new OnClickListener() {				
			...
			public void onClick(View chatIconView) {	
				if(!isFBLoggedIn)
					bottomPaddingView.setVisibility(View.VISIBLE);
				HopinTracker.sendEvent("NewUserDialog","ButtonClick","newuserdialog:click:chatIcon",1L,getTrackerMap());
		...
		facebookIcon.setOnClickListener(new OnClickListener() {				
			...
			public void onClick(View chatIconView) {
				if(!isFBLoggedIn)
					bottomPaddingView.setVisibility(View.VISIBLE);
				HopinTracker.sendEvent("NewUserDialog","ButtonClick","newuserdialog:click:facebookIcon",1L,getTrackerMap());
