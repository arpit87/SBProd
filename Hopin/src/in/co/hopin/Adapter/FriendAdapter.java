...
public class FriendAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if( position%2 == 0)        
        	thisUserView = inflater.inflate(R.layout.friend_row_left, null);
        else        		
        	thisUserView = inflater.inflate(R.layout.friend_row_right, null);
        
        ImageView userImageView = (ImageView)thisUserView.findViewById(R.id.friend_image);       
        TextView userName = (TextView)thisUserView.findViewById(R.id.friend_name);               
        SBImageLoader.getInstance().displayImage(thisMutualFriend.getImageURL(), userImageView);
